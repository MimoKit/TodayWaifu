"""TodayWaifu message delivery and platform compatibility."""
...
async def _target_send_without_bot_hooks(bot: Bot, message: Any, *args: Any, **kwargs: Any) -> Any:
    ...
    return await bot.bot.target_send(message, target_type, target_id, ev.real_bot_id, bot.bot_self_id, ev.msg_id, at_sender, ev.user_id, ev.group_id, ev.task_id, ev.task_event, extra_metadata=extra_metadata, wait_recall=wait_recall)
